...
| POST | `/api/cargas/:id/desbloqueo` | TRANSPORTADOR | Gratis con membresía ILIMITADA (revela el contacto directo); si no, cobra 6% del flete (mín. $15.000, máx. $100.000) vía Wompi y devuelve `checkoutUrl` |
